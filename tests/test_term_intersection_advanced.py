...
class TestTermIntersectionAdvanced:
    ...
    def test_both_positive_terms_intersection(self):
        ...
        term1 = Term(self.pkg, VersionRange(Version("1.0.0"), Version("3.0.0"), True, False), True)  # [1.0.0, 3.0.0)
        term2 = Term(self.pkg, VersionRange(Version("2.0.0"), Version("4.0.0"), True, False), True)  # [2.0.0, 4.0.0)
    ...
    def test_both_positive_terms_no_intersection(self):
        ...
        term1 = Term(self.pkg, VersionRange(Version("1.0.0"), Version("2.0.0"), True, False), True)  # [1.0.0, 2.0.0)
        term2 = Term(self.pkg, VersionRange(Version("3.0.0"), Version("4.0.0"), True, False), True)  # [3.0.0, 4.0.0)
    ...
    def test_both_negative_terms_intersection(self):
        ...
        term1 = Term(self.pkg, VersionRange(Version("1.0.0"), Version("2.0.0"), True, False), False)  # NOT [1.0.0, 2.0.0)
        term2 = Term(self.pkg, VersionRange(Version("1.5.0"), Version("2.5.0"), True, False), False)  # NOT [1.5.0, 2.5.0)
    ...
    def test_positive_and_negative_intersection(self):
        ...
        term1 = Term(self.pkg, VersionRange(Version("1.0.0"), Version("3.0.0"), True, False), True)   # [1.0.0, 3.0.0)
        term2 = Term(self.pkg, VersionRange(Version("2.0.0"), Version("4.0.0"), True, False), False)  # NOT [2.0.0, 4.0.0)
    ...
    def test_negative_and_positive_intersection(self):
        ...
        term1 = Term(self.pkg, VersionRange(Version("1.0.0"), Version("2.0.0"), True, False), False)  # NOT [1.0.0, 2.0.0)
        term2 = Term(self.pkg, VersionRange(Version("1.5.0"), Version("3.0.0"), True, False), True)   # [1.5.0, 3.0.0)
    ...
    def test_positive_negative_no_overlap(self):
        ...
        term1 = Term(self.pkg, VersionRange(Version("1.0.0"), Version("2.0.0"), True, False), True)   # [1.0.0, 2.0.0)
        term2 = Term(self.pkg, VersionRange(Version("3.0.0"), Version("4.0.0"), True, False), False)  # NOT [3.0.0, 4.0.0)
    ...
    def test_negative_positive_no_overlap(self):
        ...
        term1 = Term(self.pkg, VersionRange(Version("3.0.0"), Version("4.0.0"), True, False), False)  # NOT [3.0.0, 4.0.0)
        term2 = Term(self.pkg, VersionRange(Version("1.0.0"), Version("2.0.0"), True, False), True)   # [1.0.0, 2.0.0)
    ...
    def test_different_packages_intersection(self):
        ...
        term1 = Term(pkg1, VersionRange(Version("1.0.0"), Version("2.0.0"), True, False), True)
        term2 = Term(pkg2, VersionRange(Version("1.0.0"), Version("2.0.0"), True, False), True)
        
        # Different packages can't intersect - should raise ValueError
        with pytest.raises(ValueError, match="Cannot intersect terms for different packages"):
    ...
    def test_complex_boundary_conditions(self):
        ...
        term1 = Term(self.pkg, VersionRange(Version("1.0.0"), Version("2.0.0"), True, False), True)   # [1.0.0, 2.0.0)
        term2 = Term(self.pkg, VersionRange(Version("2.0.0"), Version("3.0.0"), True, False), False)  # NOT [2.0.0, 3.0.0)
